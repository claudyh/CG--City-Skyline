/*CG_CAM_EXTRAS
LookAt functions developed for the Computer Graphics course:
...
//Calculates frustum based on theta, alpha and beta
inline void perspective(GLfloat theta, GLfloat alpha, GLfloat beta, bool invertX = true, bool invertY = false) {
